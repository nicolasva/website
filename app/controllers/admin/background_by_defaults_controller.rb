    ...
    private
      ...
      def background_by_default_params
        params.require(:background_by_default).permit(:id,
                                                      ...
                                                      :activation,
                                                      activation: [],
                                                      background_attributes: [:border, :border_style, :delete_background_image, :no_background_image, :background_image, :background_image_cache, :no_repeat, :border_color, :align]
                                                     )
      end
  end
end

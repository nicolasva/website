      ...
      unless _.isNull(data)
        unless data.background.no_background_image 
          ...
          if data.background.align == 11
            ...
            $('.background_by_default').css("-moz-background-size", $(window).width()+"px" $(window).height()+"px")
            $('.background_by_default').css("-o-background-size", $(window).width()+"px" $(window).height()+"px")
            $('.background_by_default').css("-webkit-background-size", $(window).width()+"px" $(window).height()+"px")
            $('.background_by_default').css("background-size", $(window).width()+"px" $(window).height()+"px")
      ...
      unless _.isNull(data)
        unless data.background.no_background_image 
          ...
          if data.background.align == 11
            ...
            $('.menu_color').css("-moz-background-size", $(window).width()+"px" $(window).height()+"px")
            $('.menu_color').css("-o-background-size", $(window).width()+"px" $(window).height()+"px")
            $('.menu_color').css("-webkit-background-size", $(window).width()+"px" $(window).height()+"px")
            $('.menu_color').css("background-size", $(window).width()+"px" $(window).height()+"px")
      ...
      unless _.isNull(data)
        unless data.background.no_background_image
          ...
          if data.background.align == 11
            ...
            $('.sub_menu').css("-moz-background-size", $(window).width()+"px" $(window).height()+"px")
            $('.sub_menu').css("-o-background-size", $(window).width()+"px" $(window).height()+"px")
            $('.sub_menu').css("-webkit-background-size", $(window).width()+"px" $(window).height()+"px")
            $('.sub_menu').css("background-size", $(window).width()+"px" $(window).height()+"px")
